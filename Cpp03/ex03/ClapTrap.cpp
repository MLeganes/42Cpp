...
// Copy constructors.
ClapTrap::ClapTrap(const ClapTrap &copy) : _name(copy.getName() + "_clap_name"), _hitPoints(copy.getHitPoints()), _energyPoints(copy.getEnergyPoints()), _attackDamage(copy.getAttackDamage())
{
